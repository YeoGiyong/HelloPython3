...
from random import randint   #모듈명을 줄여쓰기
#import Lab03
#import math
#from math import pi
...
import yeogiyong            #사용자 모듈

#import yeo.hello
from yeo.hello import sayHello


#모듈을 호출할땨는 모듈명(파일이름).함수명
